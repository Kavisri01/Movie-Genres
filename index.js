...
app.get("/vidly.com/api/genres/:id",(req,res) => {
    ...
    if(!genre) return res.status(400).send('The genre with the id is not found');
    res.send(genre);
})
//To Post Genres of the movie
...
app.listen(3000, ()=> console.log("Connection Established to the port 3000....."));